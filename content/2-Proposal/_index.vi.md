...
- *Lưu trữ dữ liệu*: Dữ liệu thô và dữ liệu đã xử lý được lưu trữ trên AWS S3 với nhiều bucket riêng biệt, tạo data lake và kho dữ liệu sẵn sàng phân tích.
...
*Tổng*: 5.85 USD/tháng, ~70.2 USD/12 tháng    
