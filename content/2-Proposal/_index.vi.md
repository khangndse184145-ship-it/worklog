...
- *Xử lý dữ liệu*: AWS Lambda xử lý các sự kiện serverless, dữ liệu được lập chỉ mục.
...
3. *Điều chỉnh kiến trúc để tối ưu chi phí/giải pháp*: Tinh chỉnh các dịch vụ (ví dụ tối ưu Lambda, Amplify) và quy trình xử lý dữ liệu để đạt hiệu quả tối đa (Tháng 2).  
